...
<html> 
    ...
    <body> 
      ...
      <header>
            ...
            <nav class="navbar-expand-lg">
              ...
              <div class="collapse navbar-collapse menu-line" id="navbarTogglerDemo01">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" href="fochistInfo.php">Vreme</a>
                  </li>
                  <li class="nav-item">
        ...
        <div class="content">
            <script type='text/javascript' src='https://darksky.net/widget/default/44.3189,23.8047/ca12/en.js?width=100%&height=500&title=Craiova&textColor=333333&bgColor=ransparent&transparency=false&skyColor=undefined&fontFamily=Trebuchet MS&customFont=&units=ca&htColor=ea0909&ltColor=3409ea&displaySum=yes&displayHeader=yes'></script>
        </div>
