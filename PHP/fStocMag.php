...
<html> 
    <head> 
        ...
        <link rel="stylesheet" href="../CSS/fStocMag.css">
            ...
            <nav class="navbar-expand-lg">
              ...
              <div class="collapse navbar-collapse menu-line" id="navbarTogglerDemo01">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                    <a class="nav-link" href="applications.php">Formular Cereri</a>
                  </li>
                    <li class="nav-item">
                    <a class="nav-link" href="CereriAprobate.php">Verifica Cerere</a>
                  </li>
                    <li class="nav-item">
                    <a class="nav-link active" href="fStocMag.php">Informatii stoc magazie</a>
                  </li>
                  <li class="nav-item">
        ...
        <div class="content">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
              <div class="form-row">
                <div class="form-group col-md-2">
                  ...
                  <input type="text" class="form-control" id="IDprodus" name="IDProdus" placeholder="ID produs" required>
                </div>
                <div class="form-group col-md-6">
                  <label for="Cantitate">Cantitate</label>
                  <input type="text" class="form-control" id="Cantitate" name="Cantitate" placeholder="Cantitate" required>
                </div>
                  <div class="form-group col-md-2">
                  <label for="dAchizitie">Data achizitie:</label>
                  <input type="date" class="form-control" id="dAchizitie" name="dataAchizitie" placeholder="Data achizitie" required>
                </div>
                <div class="form-group col-md-2">
                    <br>
            ...
            <?php
                if (isset($_POST['salveaza'])) {
                    ...
                    $dataAchizitie = empty($_POST['dataAchizitie']) ? die ("ERROR: Introduceti data achizitiei!") : mysqli_real_escape_string($connection, $_POST['dataAchizitie']);
                    // create query
                    $queryInsert = "UPDATE magazie SET cantitate='$cantitate', data_achizitie='$dataAchizitie' WHERE id_prod='$id_produs'";
            ...
            <?php
                ...
                // select database 
                mysqli_select_db($connection, $db) or die ("Unable to select database!"); 
                $querySelect = "SELECT * FROM magazie";
